...
def cargar_modelo(filename="Modelo_MNIST.json"):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--load", type=str, default="Modelo_MNIST.json", help="Ruta a un modelo JSON previamente guardado")
